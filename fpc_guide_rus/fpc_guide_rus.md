...
Здесь мы перечисляем модули, которые идут с распространяемым Free Pascal. Поскольку в поставляемом модуле для каждой операционной системы есть различия, мы сначала опишем общие, а затем опишем те, которые относятся к конкретной операционной системе.


### 9.1 Стандартные модули.

Следующие модули являются стандартными и предназначены для переноса на все платформы, поддерживаемые Free Pascal. Краткое описание каждого модуля также приводится.
